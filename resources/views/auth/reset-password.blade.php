<x-layouts.auth title="Nouveau mot de passe — Klymap">
    ...
    <form class="space-y-5" method="POST" action="{{ route('password.update') }}" novalidate>
        @csrf
        ...
        <div>
            <label for="password" class="block text-sm font-semibold text-slate-700 mb-1.5">Nouveau mot de passe</label>
            <div class="relative">
                <input
                    type="password"
                    id="password"
